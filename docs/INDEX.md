...
- `docs/design/view_controller_decomposition.md` — Design spike; Prereqs 1 (#97) and 2 (#98) are done, splitting the two largest Swift files still isn't. anchors: goal, why-this-is-a-design-spike-not-a-direct-refactor, 1-responsibility-inventory, 2-proposed-target-structure, 3-behavior-parity-verification-plan, 4-recommended-extraction-order covers: src/swift/MarcutApp/Sources/MarcutApp/SettingsView.swift, src/swift/MarcutApp/Sources/MarcutApp/DocumentRedactionViewModel.swift, src/swift/MarcutApp/Sources/MarcutApp/RedactionRunning.swift
