...
- `docs/design/view_controller_decomposition.md` — Design spike; Prereqs 1 (#97), 2 (#98), 3 (#99), 4 (#100, the golden bridge-call characterization harness gating every extraction slice), 5 (#101, direct-call characterization tests for state/ETA/artifacts/env-restore/diagnostics/pending-job recovery -- six of seven targets, one blocked on a missing visibility seam), and 6 (#102, the UserDefaults migration-matrix characterization for the two independent `AdvancedModeDefaultsMigrator` seeding sites, incl. two named tests pinning their drift) are done, splitting the two largest Swift files still isn't. anchors: goal, why-this-is-a-design-spike-not-a-direct-refactor, 1-responsibility-inventory, 2-proposed-target-structure, 3-behavior-parity-verification-plan, 4-recommended-extraction-order covers: src/swift/MarcutApp/Sources/MarcutApp/SettingsView.swift, src/swift/MarcutApp/Sources/MarcutApp/DocumentRedactionViewModel.swift, src/swift/MarcutApp/Sources/MarcutApp/RedactionRunning.swift, src/swift/MarcutApp/Sources/MarcutApp/MetadataCleaningSettings.swift, src/swift/MarcutApp/Tests/MarcutAppTests/RecordingRedactionRunner.swift, src/swift/MarcutApp/Tests/MarcutAppTests/RedactionCharacterizationHarness.swift, src/swift/MarcutApp/Tests/MarcutAppTests/RedactionCharacterizationTests.swift, src/swift/MarcutApp/Tests/MarcutAppTests/ViewModelCharacterizationTests.swift, src/swift/MarcutApp/Tests/MarcutAppTests/AdvancedModeDefaultsMigrationTests.swift
