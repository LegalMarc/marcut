...
final class UserOverridesManager {
    ...
    func loadExcludedWords() throws -> String {
        try String(contentsOf: activeExcludedWordsURL, encoding: .utf8)
    }
    ...
    func defaultExcludedWords() throws -> String {
        ...
        throw NSError(
            ...
            code: 404,
            userInfo: [NSLocalizedDescriptionKey: "Default excluded-words.txt not found in bundle"]
        )
    }
    ...
    func loadSystemPrompt() throws -> String {
        try String(contentsOf: activeSystemPromptURL, encoding: .utf8)
    }
    ...
    func defaultSystemPrompt() throws -> String {
        ...
        throw NSError(
            domain: "UserOverrides",
            code: 404,
            userInfo: [NSLocalizedDescriptionKey: "Default system-prompt.txt not found in bundle"]
        )
    }
