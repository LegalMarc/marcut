...
final class DocumentRedactionViewModel: ObservableObject {
    ...
    // slice 7); `generateMetadataReport`/`generateMetadataReportsInPlace`/`scrubDocumentMetadataOnly`
    // below (staying on the view model until #110/#111) and `ContentView.swift` both still call
