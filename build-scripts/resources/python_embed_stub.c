...
int main(int argc, char *argv[]) {
    ...
    snprintf(python_site_path, sizeof(python_site_path), "%s/Resources/python_site", contents_dir);
    snprintf(python_lib_path, sizeof(python_lib_path), "%s/lib/python%s", python_home, python_version);
    snprintf(python_dynload_path, sizeof(python_dynload_path), "%s/lib/python%s/lib-dynload", python_home, python_version);
    snprintf(python_sitepackages_path, sizeof(python_sitepackages_path), "%s/lib/python%s/site-packages", python_home, python_version);
