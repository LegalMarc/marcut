...
class AppEnvironmentValidator:
    ...
    def test_python_kit_environment(self) -> bool:
        ...
        # Test Python executable in framework
        python_exec = framework_path / "Versions/3.11/Python"
        python_works = False
        python_version = None
        ...
        if python_exec.exists():
            try:
                ...
                self.log_test(
                    ...
                    python_works,
                    f"Python executable {'works' if python_works else 'failed'}",
                    {
                ...
                self.log_test("Python Executable Test", False, "Python executable timeout")
            except Exception as e:
                self.log_test("Python Executable Test", False, f"Python executable error: {e}")
        else:
            self.log_test("Python Executable Test", False, "Python executable not found")
