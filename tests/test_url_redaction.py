...
class TestURLRedaction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_texts = {
            ...
            'mixed_content': "Email us at test@example.com or visit https://help.site.com/support",
            ...
            'mailto_url': "Contact us via mailto:support@example.com for assistance.",
            ...
            For support, visit https://support.company.com or email support@company.com.
    ...
    def test_url_pattern_detection(self):
        ...
        # Test mailto URL
        matches = list(URL.finditer("Contact mailto:support@example.com for help"))
        self.assertEqual(len(matches), 1, "Should detect mailto URL")
        self.assertEqual(matches[0].group(), "mailto:support@example.com")
    ...
    def test_url_detection_in_rules_engine(self):
        ...
        self.assertEqual(mailto_spans[0]['text'], 'mailto:support@example.com')
    ...
    def test_url_id_with_mixed_entities(self):
        ...
        spans = [
            {"start": 0, "end": 15, "label": "EMAIL", "text": "test@email.com", "confidence": 0.95, "source": "rule"},
